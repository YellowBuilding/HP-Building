...
function SideBySideDiagram() {
  ...
  return (
    <svg viewBox="0 0 960 270" className="w-full h-auto" style={{ maxHeight: 380 }}>
      ...
      <text x={(GAS_SQ_X + GAS_WARMTE_TIP) / 2} y={Y1 + 28} textAnchor="middle" fontFamily="Bricolage Grotesque, sans-serif" fontSize="12" fontWeight="600" fill="#AAAAAA" letterSpacing="0.14em">GASKETEL</text>
      ...
      <text x={(HP_SQ_X + HP_WARMTE_TIP) / 2} y={Y1 + 28} textAnchor="middle" fontFamily="Bricolage Grotesque, sans-serif" fontSize="12" fontWeight="600" fill="#8FD8A1" letterSpacing="0.14em">WARMTEPOMP</text>
